...
const resolvers = {
  ...
  Mutation: {
    ...
    editAuthor: (root, args) => {
      ...
      const authorToEdit = authors.find(author => author.name === authorName)

      if (!authorToEdit) {
        return null
      }

      const edittedAuthor = { ...authorToEdit, born: args.setBornTo }
      authors = authors.map(
        author => author.name !== authorName ? author : edittedAuthor
      )
